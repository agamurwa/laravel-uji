...
<div class="card shadow mb-4">
            ...
            <div class="table" id="PilihPasien" style="">
              ...
              <div class="row g-3 align-items-center mt-2">
                <div class="col-auto">
                  <form action="add-rekam-medis" method="GET" class="form-inline">
                    ...
                    @foreach ($items as $item)
                      <tr>
                        ...
                        @if (auth()->user()->profesi== 'Dokter')
                          <a href="{{route('add-rekam-medis.show',$item->id)}}" class="btn btn-primary btn-sm btn-icon-split">
                          ...
                          @elseif (auth()->user()->profesi=='Staff')
                            <a href="{{route('add-rekam-medis.show',$item->id)}}" class="btn btn-primary btn-sm btn-icon-split disabled">
                            <span class="icon text-white-50">
                            <i style="padding-top:4px"class="fas fa-check"></i>
                            </span>
                            <span class="text">Pilih</span>
